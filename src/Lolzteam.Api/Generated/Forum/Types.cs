...
{
    [Lolzteam.Api.Runtime.EnumValue("*")] Value1536706017,
...
public sealed record Resp_ChatboxMessageModel(
    [property: JsonPropertyName("can_report")] JsonElement CanReport,
    [property: JsonPropertyName("date")] double Date,
    [property: JsonPropertyName("is_deleted")] JsonElement IsDeleted,
...
public sealed record Resp_ChatboxMessageModelRoom(
    [property: JsonPropertyName("can_report")] JsonElement? CanReport,
    [property: JsonPropertyName("eng")] JsonElement? Eng,
    [property: JsonPropertyName("market")] JsonElement? Market,
...
public sealed record Resp_ChatboxMessageModelUser(
    ...
    [property: JsonPropertyName("is_admin")] JsonElement? IsAdmin,
    [property: JsonPropertyName("is_banned")] JsonElement? IsBanned,
    [property: JsonPropertyName("is_moderator")] JsonElement? IsModerator,
    [property: JsonPropertyName("is_staff")] JsonElement? IsStaff,
...
public sealed record Resp_ConversationMessageModel(
    ...
    [property: JsonPropertyName("message_need_translate")] JsonElement MessageNeedTranslate,
    [property: JsonPropertyName("message_is_system")] JsonElement MessageIsSystem,
...
public sealed record Resp_ConversationMessageModelPermissions(
    ...
    [property: JsonPropertyName("stick-unstick")] JsonElement? StickUnstick
);
...
public sealed record Resp_ConversationModel(
    ...
    [property: JsonPropertyName("conversation_is_new")] JsonElement ConversationIsNew,
    [property: JsonPropertyName("creator_is_ignored")] JsonElement CreatorIsIgnored,
    [property: JsonPropertyName("conversation_is_open")] JsonElement ConversationIsOpen,
    [property: JsonPropertyName("conversation_is_deleted")] JsonElement ConversationIsDeleted,
...
public sealed record Resp_ConversationModelPermissions(
    ...
    [property: JsonPropertyName("invite")] JsonElement? Invite,
    [property: JsonPropertyName("manage_invite_links")] JsonElement? ManageInviteLinks,
    [property: JsonPropertyName("kick")] JsonElement? Kick,
    [property: JsonPropertyName("upload_avatar")] JsonElement? UploadAvatar,
    [property: JsonPropertyName("editOwnPost")] JsonElement? EditOwnPost,
    [property: JsonPropertyName("stickyMessages")] JsonElement? StickyMessages
);
...
public sealed record Resp_ConversationModelRecipient(
    ...
    [property: JsonPropertyName("last_activity")] double? LastActivity,
    [property: JsonPropertyName("is_online")] JsonElement? IsOnline,
    [property: JsonPropertyName("contacts_changed")] JsonElement? ContactsChanged,
...
public sealed record Resp_NotificationModel(
    ...
    [property: JsonPropertyName("notification_is_unread")] JsonElement NotificationIsUnread,
    [property: JsonPropertyName("creator_user_id")] double CreatorUserId,
    [property: JsonPropertyName("creator_username")] string CreatorUsername,
    [property: JsonPropertyName("creator_username_html")] string CreatorUsernameHtml,
...
public sealed record Resp_PostCommentModel(
    ...
    [property: JsonPropertyName("user_is_ignored")] JsonElement UserIsIgnored,
    [property: JsonPropertyName("post_comment_is_published")] JsonElement PostCommentIsPublished,
    [property: JsonPropertyName("post_comment_is_deleted")] JsonElement PostCommentIsDeleted,
...
public sealed record Resp_ProfilePostModel(
    ...
    [property: JsonPropertyName("post_is_sticked")] JsonElement PostIsSticked,
...
public sealed record Resp_ProfilePostModelPermissions(
    ...
    [property: JsonPropertyName("report")] JsonElement? Report,
    [property: JsonPropertyName("stick")] JsonElement? Stick
);
...
public sealed record Resp_ThreadModelContestPermissions(
    [property: JsonPropertyName("can_finish")] JsonElement? CanFinish,
    [property: JsonPropertyName("can_participate")] JsonElement? CanParticipate,
    [property: JsonPropertyName("can_participate_error")] string? CanParticipateError,
    [property: JsonPropertyName("can_view_user_list")] JsonElement? CanViewUserList
);
...
public sealed record Resp_ThreadModelContest(
    ...
    [property: JsonPropertyName("already_participate")] JsonElement? AlreadyParticipate,
...
public sealed record Resp_UserModel(
    ...
    [property: JsonPropertyName("user_is_valid")] JsonElement UserIsValid,
    [property: JsonPropertyName("user_is_verified")] JsonElement UserIsVerified,
    [property: JsonPropertyName("user_is_followed")] JsonElement UserIsFollowed,
    ...
    [property: JsonPropertyName("user_is_ignored")] JsonElement UserIsIgnored,
    [property: JsonPropertyName("user_is_visitor")] JsonElement UserIsVisitor,
...
public sealed record Resp_UserModelPermissions(
    [property: JsonPropertyName("edit")] JsonElement? Edit,
    [property: JsonPropertyName("follow")] JsonElement? Follow,
    [property: JsonPropertyName("ignore")] JsonElement? Ignore,
...
public sealed record Resp_UserModelUserGroups(
    ...
    [property: JsonPropertyName("display_group_selectable")] JsonElement? DisplayGroupSelectable,
    [property: JsonPropertyName("display_banner_selectable")] JsonElement? DisplayBannerSelectable,
    [property: JsonPropertyName("display_icon_selectable")] JsonElement? DisplayIconSelectable,
    [property: JsonPropertyName("is_primary_group")] JsonElement? IsPrimaryGroup,
...
public sealed record Resp_UserModelFields(
    ...
    [property: JsonPropertyName("is_required")] JsonElement? IsRequired,
    [property: JsonPropertyName("value")] string? Value,
    [property: JsonPropertyName("is_multi_choice")] JsonElement? IsMultiChoice,
...
public sealed record Resp_UserModelSelfPermissions(
    [property: JsonPropertyName("create_conversation")] JsonElement? CreateConversation
);

public sealed record Resp_UserModelEditPermissions(
    [property: JsonPropertyName("password")] JsonElement? Password,
    [property: JsonPropertyName("user_email")] JsonElement? UserEmail,
    [property: JsonPropertyName("username")] JsonElement? Username,
    [property: JsonPropertyName("user_title")] JsonElement? UserTitle,
    [property: JsonPropertyName("short_link")] JsonElement? ShortLink,
    [property: JsonPropertyName("hide_username_logs")] JsonElement? HideUsernameLogs,
    [property: JsonPropertyName("primary_group_id")] JsonElement? PrimaryGroupId,
    [property: JsonPropertyName("secondary_group_ids")] JsonElement? SecondaryGroupIds,
    [property: JsonPropertyName("user_dob_day")] JsonElement? UserDobDay,
    [property: JsonPropertyName("user_dob_month")] JsonElement? UserDobMonth,
    [property: JsonPropertyName("user_dob_year")] JsonElement? UserDobYear,
...
public static class ChatboxApiTypes
{
    ...
    [property: JsonPropertyName("deleteAnyMessage")] JsonElement? DeleteAnyMessage,
    [property: JsonPropertyName("editAnyMessage")] JsonElement? EditAnyMessage,
    [property: JsonPropertyName("viewAnyMessage")] JsonElement? ViewAnyMessage,
    [property: JsonPropertyName("viewMessages")] JsonElement? ViewMessages,
    [property: JsonPropertyName("postMessage")] JsonElement? PostMessage,
    [property: JsonPropertyName("ban")] JsonElement? Ban
);
...
public static class ConversationsApiTypes
{
    ...
    public sealed record ConversationsListResponse(
        ...
        [property: JsonPropertyName("can_start")] JsonElement CanStart,
    ...
    public sealed record ConversationsSearchResponse(
        [property: JsonPropertyName("conversations")] List<JsonElement> Conversations,
        [property: JsonPropertyName("recipients")] JsonElement Recipients,
        [property: JsonPropertyName("system_info")] JsonElement SystemInfo
    );
...
public static class NavigationApiTypes
{
    ...
    [property: JsonPropertyName("has_sub_elements")] JsonElement? HasSubElements
);
}
...
public static class ProfilePostsApiTypes
{
    ...
    public sealed record ProfilePostsListResponse(
        ...
        [property: JsonPropertyName("canPostOnProfile")] JsonElement CanPostOnProfile,
...
public static class ThreadsApiTypes
{
    ...
    [property: JsonPropertyName("vote")] JsonElement? Vote,
    ...
    [property: JsonPropertyName("poll_is_open")] JsonElement? PollIsOpen,
    [property: JsonPropertyName("poll_is_voted")] JsonElement? PollIsVoted,
...
public static class UsersApiTypes
{
    ...
    [property: JsonPropertyName("can_edit")] JsonElement? CanEdit,
    [property: JsonPropertyName("can_follow")] JsonElement? CanFollow,
    [property: JsonPropertyName("can_ignore")] JsonElement? CanIgnore,
    [property: JsonPropertyName("can_post_profile")] JsonElement? CanPostProfile,
    [property: JsonPropertyName("can_view_profile")] JsonElement? CanViewProfile,
    [property: JsonPropertyName("can_view_profile_posts")] JsonElement? CanViewProfilePosts,
    [property: JsonPropertyName("can_warn")] JsonElement? CanWarn,
    [property: JsonPropertyName("contest_count")] double? ContestCount,
    [property: JsonPropertyName("conv_welcome_message")] string? ConvWelcomeMessage,
    ...
    [property: JsonPropertyName("is_admin")] JsonElement? IsAdmin,
    [property: JsonPropertyName("is_banned")] JsonElement? IsBanned,
    [property: JsonPropertyName("is_followed")] JsonElement? IsFollowed,
    [property: JsonPropertyName("is_ignored")] JsonElement? IsIgnored,
    [property: JsonPropertyName("is_moderator")] JsonElement? IsModerator,
    [property: JsonPropertyName("is_staff")] JsonElement? IsStaff,
    [property: JsonPropertyName("last_activity")] double? LastActivity,
    [property: JsonPropertyName("like2_count")] double? Like2Count,
